 ...
 * 
 */
package io.github.kennedykori.sudoku.core;
...
import static io.github.kennedykori.utils.ObjectUtils.requireGreaterThanOrEqualTo;
import static io.github.kennedykori.utils.ObjectUtils.requireInRange;
...
public final class Symbols {
	 ...
	 */
	private static final Comparator<Symbol<?>> DEFAULT_SYMBOL_COMPARATOR = Comparator.comparingInt(Symbol::id);
	 ...
	 */
	public static <V> Symbol<V> of(Integer id, V value) {
		return new SymbolImpl<>(id, value);
	}
	 ...
	 */
	public static Set<Symbol<Integer>> numberSymbolsUpTo(int upTo) {
	 ...
	 */
	public static Set<Symbol<Character>> letterSymbolsUpTo(int upTo) {
	 ...
	 */
	public static Comparator<Symbol<?>> defaultComparator() {
	 ...
	 */
	public static int hashCode(Symbol<?> symbol) {
	 ...
	 * @throws NullPointerException if {@code symbol} is {@code null}.
	 */
	public static boolean equals(Symbol<?> symbol, Object obj) {
		requireNonNull(symbol, "symbol cannot be null.");
		if (obj == symbol) return true;
		if (!(obj instanceof Symbol<?> _obj)) return false;
	 ...
	 */
	private static Symbol<Character> nextLetterSymbol(int offset) {
	 ...
	 * @author <a href="https://github.com/kennedykori">Kennedy Kori</a>
	 *
	 * @since Fri, 3 Apr 2026 15:11:03
	 *
	 */
	private static record SymbolImpl<V>(@NonNull Integer id, @NonNull V value) implements Symbol<V> {
		public SymbolImpl {
