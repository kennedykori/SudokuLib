...
val artifactID: String = "core"
val groupID: String = "io.github.kennedykori.sudoku"
    ...
    publications {
        create<MavenPublication>("utils") {
            ...
            pom {
                ...
                description = "A sudoku library serving as the core for a Sudoku game written in Java."
                developers {
                    developer {
                        id = "kennedykori"
                        name = "Kennedy Kori"
                ...
                licenses {
                    license {
                        name = "MIT License"
                        url = "https://github.com/kennedykori/sudoku-lib/blob/master/LICENSE"
                        distribution = "repo"
                    }
                }
                packaging = "jar"
                scm {
                    connection = "scm:git:git@github.com:kennedykori/sudoku-lib.git"
                    developerConnection = "scm:git:git@github.com:kennedykori/sudoku-lib.git"
                    url = "https://github.com/kennedykori/sudoku-lib"
                }
                url = "https://github.com/kennedykori/sudoku-lib"
            }
